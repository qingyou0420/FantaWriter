...
describe("github latest release parsing", () => {
  ...
  it("picks Inkborne-Setup and still accepts FantaWriter-Setup", () => {
    const picked = pickSetupAsset([
      ...
      {
        name: "FantaWriter-Setup-2.1.7.exe",
        browser_download_url:
          "https://github.com/qingyou0420/FantaWriter/releases/download/v2.1.7/FantaWriter-Setup-2.1.7.exe",
        url: "https://api.github.com/repos/qingyou0420/FantaWriter/releases/assets/3",
      },
      {
        name: "Inkborne-Setup-2.1.7.exe",
        browser_download_url:
          "https://github.com/qingyou0420/FantaWriter/releases/download/v2.1.7/Inkborne-Setup-2.1.7.exe",
        url: "https://api.github.com/repos/qingyou0420/FantaWriter/releases/assets/4",
      },
    ]);
    expect(picked?.name).toBe("Inkborne-Setup-2.1.7.exe");
    expect(picked?.version).toBe("2.1.7");
  });
