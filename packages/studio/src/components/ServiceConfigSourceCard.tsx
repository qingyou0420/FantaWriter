...
export function ServiceConfigSourceCard({ onChange }: { onChange?: () => void }) {
  ...
  if (!data) {
    return (
      <div className="rounded-xl border border-mark/30 bg-mark-soft p-4 text-sm text-mark-text">
  ...
  return (
    <div className="rounded-xl border border-border/40 bg-card/70 p-4 space-y-3">
      ...
      {storedConfigSource === "env" ? (
        <div className="rounded-lg border border-mark/30 bg-mark-soft p-3 text-xs text-muted-foreground/80">
          {tr(
      ...
      {envDetected ? (
        <div className="rounded-lg border border-mark/30 bg-mark-soft p-3 text-xs text-muted-foreground/80 space-y-1.5">
