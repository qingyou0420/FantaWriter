...
const strings = {
  ...
  "dash.noBooks": { zh: "书架还空着", en: "The shelf is empty" },
  ...
  "author.title": { zh: "作者资料", en: "Author profile" },
  ...
  "author.myBooks": { zh: "我的书目", en: "My books" },
  ...
  "bread.author": { zh: "作者资料", en: "Author profile" },
  ...
  // Sidebar
  "nav.system": { zh: "系统设置", en: "System Settings" },
  "nav.daemon": { zh: "守护进程", en: "Daemon" },
  "nav.logs": { zh: "AI 动态", en: "AI Activity" },
  "nav.authorProfile": { zh: "作者资料", en: "Author profile" },
  "nav.running": { zh: "运行中", en: "Running" },
  "nav.agentOnline": { zh: "代理在线", en: "Agent Online" },
  "nav.agentOffline": { zh: "代理离线", en: "Agent Offline" },
  "nav.tools": { zh: "工具列表", en: "Tools" },
  "nav.history": { zh: "问心记录", en: "Asks" },
  "nav.projectTalks": { zh: "新书与短篇", en: "New books & shorts" },
  "nav.newAsk": { zh: "新开问心", en: "New ask" },
  "nav.newAskPlaceholder": { zh: "新的问心", en: "New ask" },
  "nav.renameAsk": { zh: "重命名", en: "Rename" },
  "nav.deleteAsk": { zh: "删除这条问心", en: "Delete this ask" },
  "nav.deleteAskHint": { zh: "只删除这条问心记录，不影响书稿与设定。", en: "This only removes the ask record; the manuscript and canon stay." },
  "home.inProgress": { zh: "在创", en: "In progress" },
  "home.pausedCompleted": { zh: "暂停 · 完结", en: "Paused · Completed" },
  "home.expandBio": { zh: "展开", en: "Expand" },
  "home.collapseBio": { zh: "收起", en: "Collapse" },
  "home.editAuthor": { zh: "编辑作者资料", en: "Edit author profile" },
  "home.pause": { zh: "移入暂停", en: "Move to paused" },
  "home.resume": { zh: "恢复", en: "Resume" },
  "home.noModel": { zh: "还没有配置 AI 模型", en: "No AI model configured yet" },
  ...
  "book.export": { zh: "导出原文", en: "Export manuscript" },
  "book.exportSave": { zh: "保存原文到项目", en: "Save manuscript to project" },
  ...
  "logs.title": { zh: "AI 动态", en: "AI Activity" },
  "logs.empty": { zh: "暂无动态", en: "No activity yet" },
  "logs.showingRecent": { zh: "当前展示最近动态与原始日志。", en: "Showing recent activity and raw log entries." },
