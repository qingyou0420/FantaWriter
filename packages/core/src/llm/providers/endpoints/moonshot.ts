...
export const MOONSHOT: InkosEndpoint = {
  ...
  temperatureHint: "kimi-k3 / k2.5 / k2.6 / k2.7 强制 temperature=1.0，建议省略采样参数",
  models: [
    { id: "kimi-k3", maxOutput: 131072, contextWindowTokens: 1_000_000, enabled: true, releasedAt: "2026-08-31", temperature: 1 },
    { id: "kimi-k2.7-code", maxOutput: 32768, contextWindowTokens: 262144, enabled: true, releasedAt: "2026-08-31", temperature: 1 },
    { id: "kimi-k2.7-code-highspeed", maxOutput: 32768, contextWindowTokens: 262144, enabled: true, releasedAt: "2026-08-31", temperature: 1 },
